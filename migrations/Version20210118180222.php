 ...
 */
final class Version20210118180222 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD biography LONGTEXT DEFAULT NULL, ADD age INT DEFAULT NULL, ADD city VARCHAR(50) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP biography, DROP age, DROP city');
    }
}
